...
root_scripts=(
  ...
  "${cybr_demos_path}/compute_init/ubuntu/install_docker.sh"
  "${cybr_demos_path}/compute_init/ubuntu/install_terraform.sh"
  "${cybr_demos_path}/compute_init/ubuntu/install_awscli.sh"
  "${cybr_demos_path}/compute_init/ubuntu/install_azurecli.sh"
  "${cybr_demos_path}/compute_init/ubuntu/install_gcpcli.sh"
